...
?>
	...
	<form class="form-inline" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
		<?=bitrix_sessid_post()?>
        ...
        <button  id="bx_subscribe_btn_<?=$buttonId?>" type="submit" class="btn"><?=GetMessage("subscr_form_button")?></button>
